...
CREATE TABLE role (
	id BIGINT NOT NULL AUTO_INCREMENT,
	nome ENUM ('MENU_LOJA','MENU_USUARIO','MENU_PROMOCAO','MENU_PERFIL','MENU_VOUCHER','BUSCAR_LOJA','ALTERAR_LOJA','CADASTRAR_LOJA','APAGAR_LOJA','BUSCAR_USUARIO','ALTERAR_USUARIO','CADASTRAR_USUARIO','APAGAR_USUARIO','BUSCAR_PROMOCAO','ALTERAR_PROMOCAO','CADASTRAR_PROMOCAO','APAGAR_PROMOCAO','BUSCAR_PERFIL','ALTERAR_PERFIL','CADASTRAR_PERFIL','APAGAR_PERFIL','BUSCAR_VOUCHER','ALTERAR_VOUCHER','CADASTRAR_VOUCHER','APAGAR_VOUCHER'),
	PRIMARY KEY (id)
)ENGINE=InnoDB;
